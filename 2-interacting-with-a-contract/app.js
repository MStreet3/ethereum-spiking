...
// We will use this function to show the status of the accounts generated by ganache-cli
const synchAccounts = () => {
  $('#gas-price').html(`<b>Gas Price: ${web3.fromWei(web3.eth.gasPrice, 'gwei')} gwei</b>`);
...
$('#send').click(() => {
  ...
  $("#transaction-hash").text(`Latest Tx Hash: ${transactionHash}`);
